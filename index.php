        ...
        <div class="row probootstrap-vh-100 align-items-center  text-md-left text-sm-center text-center">
          ...
          <div class="col-md-6 order-md-1 order-2">
            <div class="probootstrap-text">
              <h1 class="probootstrap-heading probootstrap-stagger text-white mb-2">Banking Made Easier</h1>
              <p class="mb-5 probootstrap-stagger lead">Transfer money with just one click and Enjoy!!!</p>
              <p class="probootstrap-stagger"><a href="customers.php" class="btn btn-primary mr-2 mb-2"><span class="icon-ipad"></span>All Customers</a><a href="transactions.php" class="btn btn-primary btn-outline-white mb-2">Transactions</a></p>
            </div>
          </div>
        </div>
      </div>
